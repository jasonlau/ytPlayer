 	...
 	$.fn.extend({ 
 		ytplayer: function(options) {
    		...
    		return this.each(function() {                
                ...
                output = '<div id="' + o.swfobjectUniqueId + '"></div>\n<script type="text/javascript">var params = { ' + swfobject_params + ' }; var atts = { id: "' + o.id + '" }; ytplayer_swfobject.embedSWF("http://ytplayer.com/home/player/ytplayer.swf?version=' + Math.floor(Math.random()*1000) + '","' + o.swfobjectUniqueId + '", "' + o.width + '", "' + o.height + '", "' + o.flashVersion + '", null, null, params, atts);</script>\n';
                ...
                ytplayerState = function(){
                    ...
                    if(isPlayerLoaded){
                       ...
                       if(currentItem != $.cookie(o.id+'CurrentItem')){
